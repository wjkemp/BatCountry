 ...
 *
 */
#include "consolegraphicsdevice.h"



//-----------------------------------------------------------------------------
ConsoleGraphicsDevice::ConsoleGraphicsDevice(int width, int height) :
...
//-----------------------------------------------------------------------------
ConsoleGraphicsDevice::~ConsoleGraphicsDevice()
{
...
//-----------------------------------------------------------------------------
void ConsoleGraphicsDevice::render(Canvas& canvas)
{
